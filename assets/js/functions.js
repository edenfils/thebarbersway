...
(function ($) {
    ...
    $('#search-2 form').wrap('<div class="widget--content"></div>').addClass('form-search').wrapInner('<div class="input-group"></div>');
    $('#search-2 form .search-field').unwrap('label').addClass('form-control');
    $('#search-2 form .input-group .screen-reader-text').remove();
    $('#search-2 form input.search-submit').remove();
    $('#search-2 form .input-group').append('<span class="input-group-btn"><button class="btn" type="submit" value="Search"><i class="fa fa-search"></i></button></span>');

    /* ------------------ CATEGORY WIDGET CLASSES ----------------- */


    $('#categories-2 ul').wrap('<div class="widget--content"></div>').addClass('list-unstyled');

    /* ------------------ TAG WIDGET CLASSES ----------------- */

    $('#tag_cloud-2 .tagcloud').addClass('widget--content');

    $('#tag_cloud-2 .tagcloud a').removeAttr("style");

    $('.wpcf7-form-control-wrap textarea').removeAttr('cols').attr('rows', '4');
